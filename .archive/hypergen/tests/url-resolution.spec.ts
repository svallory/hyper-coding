...
describe("GitHubResolver", () => {
	...
	it("should support GitHub URLs", () => {
		...
		expect(
			resolver.supports("https://raw.githubusercontent.com/owner/repo/main/template.yml"),
		).toBe(true);
...
`;
	...
	it("should handle resolution errors gracefully", async () => {
		await expect(manager.resolveURL("./nonexistent-template", tempDir)).rejects.toThrow();
	});
