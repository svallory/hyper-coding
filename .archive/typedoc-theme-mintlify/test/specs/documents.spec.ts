...
describe(`typedoc-plugin-markdown (Integration /Documents)`, () => {
	describe(`Project`, () => {
		...
		it(`should compile a project document`, () => {
			expectFileToEqual("documents", ["modules", "members"], "documents/Project-Document-1.md", 1);
		});
	});

	describe(`Module`, () => {
		it(`should compile index page for module`, () => {
			expectFileToEqual("documents", ["modules", "members"], "ModuleWithDocuments1/README.md", 1);
		});
