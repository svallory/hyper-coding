...
describe(`typedoc-plugin-markdown (Integration /Class Reflection)`, () => {
	...
	it(`should compile class with simple props`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithSimpleProps.md");
	});

	it(`should compile class with complex props`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithComplexProps.md");
	});
	...
	it(`should compile class with constructor overloads`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithConstructorOverloads.md");
	});

	it(`should compile class with type parameters`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithTypeParameters.md");
	});

	it(`should compile class with accessors`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithAccessors.md");
	});

	it(`should compile class with modifiers`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithModifiers.md");
	});
	...
	it(`should compile disposable class`, () => {
		expectFileToEqual("reflections", "members", "classes/DisposableClass.md", 1);
	});

	it(`should compile class with symbols`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithSymbols.md", 1);
	});
	...
	it(`should compile class with prop categories`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithPropCategories.md");
	});

	it(`should compile class without prop categories`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithoutPropCategories.md");
	});

	it(`should compile class with accessor keywords`, () => {
		expectFileToEqual("reflections", "members", "classes/ClassWithAccessorKeywords.md");
	});
});
