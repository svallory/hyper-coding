...
describe(`typedoc-plugin-markdown (Integration / Text)`, () => {
	...
	it(`should get translations for member page`, () => {
		expectFileToEqual("text", "members", "module-1/interfaces/SomeInterface.md");
	});
	...
	it(`should get pageTitle templates`, () => {
		expectFileToEqual("text", "members", "module-1/classes/SomeAbstractClass.md");
		expectFileToEqual("text", "members", "module-1/classes/SomeDeprecatedAbstractClass.md");
	});
});
