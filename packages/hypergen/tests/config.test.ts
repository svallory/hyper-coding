...
import {
	...
	createConfigFile,
	getConfigInfo,
} from '../src/config/hypergen-config';
...
describe('Hypergen Configuration System', () => {
	...
	describe('HypergenConfigLoader', () => {
      ...
      `;
		...
		it('should handle missing configuration file gracefully', async () => {
			...
			await expect(
				HypergenConfigLoader.loadConfig('/non/existent/config.js', tempDir),
	...
	describe('Configuration Merging', () => {
		...
		it('should merge nested objects', async () => {
			...
			expect(config.discovery.directories).toEqual([
				'_templates',
				'templates',
				'generators',
	...
	describe('Configuration File Search', () => {
		it('should find config in parent directories', async () => {
			...
			expect(config.templates).toEqual([
				path.resolve(subDir, 'parent-templates'),
			]);
		});
