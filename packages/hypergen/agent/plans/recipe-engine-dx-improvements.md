...
Contents:
```yaml
# .hypergen/kits/@hyper-kits/nextjs.yml
# Auto-generated by hypergen setup. Commit this file.
kit: "@hyper-kits/nextjs"
version: "1.0.0"
...
- Kit `@hyper-kits/nextjs` → `.hypergen/kits/@hyper-kits/nextjs.yml`
- Cookbook `domain` within that kit → `.hypergen/kits/@hyper-kits/nextjs/domain.yml`
