...
<Steps>
  <Step title="Create cookbook directory">
...
```liquid templates/component.liquid
---
...
```liquid templates/styles.liquid
---
...
```javascript actions/update-exports.js
...
<Tip>
Hypergen provides many built-in filters for transforming variables:
</Tip>
...
<Accordion title="Partial Templates">
Break complex templates into reusable parts:

```liquid templates/partials/imports.liquid
...
<Accordion title="Dynamic File Extensions">
```liquid
---
...
<Accordion title="Conditional File Creation">
```liquid
---
...
<Tabs>
  ...
  <Tab title="Check Variable Values">
  ...
  <Tab title="Validate JSON Variables">
    ```bash
...
<CardGroup cols={3}>
  <Card title="Advanced Recipe Composition" icon="layer-group" href="/advanced-composition">
    Learn complex multi-step recipes
  </Card>
  <Card title="TypeScript Actions" icon="code" href="/tutorials/typescript-actions">
    Build custom actions with TypeScript
  </Card>
  <Card title="CodeMods and AST" icon="wand-magic-sparkles" href="/tutorials/codemods">
