...
<AccordionGroup>
  <Accordion title="Recipes" icon="book">
  ...
  <Accordion title="Steps and Tools" icon="list">
  ...
  <Accordion title="CodeMods" icon="code">
...
<Tabs>
  ...
  <Tab title="Hyper Kits">
    A kit is a shareable bundle containing one or more cookbooks and, in the future, tools, plugins, assets, etc.
    Kits can be shared via NPM or via a git repository so you can reuse them across different projects.
...
│       └── codemods/
│           └── register-plugin.js
├── enable-typedocs/                # Recipe: add TypeDoc integration
│   ├── recipe.yml
│   ├── templates/
...
<CardGroup cols={2}>
  <Card title="Install and Setup" icon="download" href="/getting-started">
    Get Hypergen running on your machine (10 minutes)
  </Card>
  <Card title="Your First Generation" icon="play" href="/getting-started#your-first-generation">
    Generate your first files (10 minutes)
  </Card>
  <Card title="Use Existing Cookbooks" icon="book" href="/tutorials/finding-cookbooks">
    Learn to use community cookbooks (15 minutes)
  </Card>
  <Card title="Create Templates" icon="file-code" href="/tutorials/creating-templates">
    Build your own templates (20 minutes)
  </Card>
</CardGroup>
