...
import { TemplateParser, type TemplateConfig, type TemplateDependency } from '#/parsers/template-parser'
// import { TemplateDependencyManager } from '#/parsers/dependency-manager'

describe.skip('Template Versioning and Dependencies - SKIPPED: dependency-manager should be in @hypercli/gen', () => {
