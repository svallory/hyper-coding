...
`packages/hypergen/tests/` → `packages/core/tests/`
...
All test files have been updated with correct import paths for core:
...
1. ✅ Files copied to core/tests
2. ✅ Import paths updated
3. ✅ Directory structure created
4. ✅ Fixture helpers copied
5. ⏭️ Run tests to verify they pass: `cd packages/core && bun test`
