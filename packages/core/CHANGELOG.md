...
* **core:** add unicode symbols for terminal messages ([52e9bfd](https://github.com/svallory/hyper-coding/commit/52e9bfd16c6e85fc619795523f5a5af588fb97bb))
* **core:** export structured message utilities from @hypercli/core ([27e82b6](https://github.com/svallory/hyper-coding/commit/27e82b67f64dc0d180369e9e2a2df072e26b1861))
* **core:** implement structured terminal message formatters ([286902d](https://github.com/svallory/hyper-coding/commit/286902d575acb30d3322cf4370fc143ae20b9748))
* **core:** improve tip message formatting and color ([27d5941](https://github.com/svallory/hyper-coding/commit/27d59412278973c9166d9f2d3bb18861427bb7b9))
* **core:** update default template dir and add AI integration config ([d6b912b](https://github.com/svallory/hyper-coding/commit/d6b912b6c2199fdfd0e75b55bd3bb6fac88cbcd2))
