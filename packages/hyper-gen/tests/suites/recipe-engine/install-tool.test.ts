...
import { InstallTool, InstallToolFactory, installToolFactory } from '#/recipe-engine/tools/install-tool'
...
describe('InstallTool', () => {
  ...
  describe('validate', () => {
    ...
    it('should pass with scoped packages', async () => {
      const step = createStep({ packages: ['@tanstack/react-query', '@types/react'] })
      const context = createContext(testDir)
  ...
  describe('command format', () => {
    it('should format bun add command correctly', async () => {
      const step = createStep({ packages: ['zod', 'react'], packageManager: 'bun' })
      const context = createContext(testDir)
    ...
    it('should format pnpm add command correctly', async () => {
      const step = createStep({ packages: ['zod', 'react'], packageManager: 'pnpm' })
      const context = createContext(testDir)
    ...
    it('should format yarn add command correctly', async () => {
      const step = createStep({ packages: ['zod', 'react'], packageManager: 'yarn' })
      const context = createContext(testDir)
    ...
    it('should format npm install command correctly', async () => {
      const step = createStep({ packages: ['zod', 'react'], packageManager: 'npm' })
      const context = createContext(testDir)
    ...
    it('should handle scoped packages in commands', async () => {
      const step = createStep({ packages: ['@tanstack/react-query', '@types/node'], packageManager: 'bun' })
      const context = createContext(testDir)
  ...
  describe('dev dependency flag', () => {
    it('should add --dev for bun when dev: true', async () => {
      const step = createStep({ packages: ['vitest'], dev: true, packageManager: 'bun' })
      const context = createContext(testDir)
    ...
    it('should add --save-dev for pnpm when dev: true', async () => {
      const step = createStep({ packages: ['vitest'], dev: true, packageManager: 'pnpm' })
      const context = createContext(testDir)
    ...
    it('should add --dev for yarn when dev: true', async () => {
      const step = createStep({ packages: ['vitest'], dev: true, packageManager: 'yarn' })
      const context = createContext(testDir)
    ...
    it('should add --save-dev for npm when dev: true', async () => {
      const step = createStep({ packages: ['vitest'], dev: true, packageManager: 'npm' })
      const context = createContext(testDir)
    ...
    it('should not add dev flag when dev is false', async () => {
      const step = createStep({ packages: ['zod'], dev: false, packageManager: 'bun' })
      const context = createContext(testDir)
