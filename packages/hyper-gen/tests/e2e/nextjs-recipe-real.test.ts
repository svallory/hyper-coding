...
describe('E2E: Real Next.js Recipe', () => {
  ...
  beforeEach(async () => {
    ...
    registry.register('ensure-dirs', 'default', ensureDirsToolFactory, { description: 'Ensure dirs tool', category: 'core' })
  ...
  it.skip('should execute nextjs project create recipe with nested sequences', async () => {
    const recipePath = path.resolve(__dirname, '../../../../hyper-kits/nextjs/cookbooks/project/create/recipe.yml')
