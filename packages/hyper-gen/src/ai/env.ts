 ...
 */
export function resolveApiKey(envVarName: string | undefined, provider: string): string | undefined {
  loadDotenv()
 ...
 */
export function hasApiKeyAvailable(envVarName: string | undefined, provider: string | undefined): boolean {
