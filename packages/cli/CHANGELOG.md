...
* **cli:** add hyper init command and fix dev script ([48177ed](https://github.com/svallory/hyper-coding/commit/48177edb97f70d306fd442630b38de978f2899e2))
...
* **cli:** add oclif utility plugins ([55f4fd6](https://github.com/svallory/hyper-coding/commit/55f4fd69673d2623ddee7bd7b51da01003994ae2))
* **cli:** render help topics and commands as styled markdown tables ([4b619bd](https://github.com/svallory/hyper-coding/commit/4b619bd33b56b677d32d8b871345cf6c8fe36104))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @hypercli/gen bumped to 0.2.1
    * @hypercli/hq bumped to 0.2.1
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @hypercli/gen bumped to 0.1.1
    * @hypercli/hq bumped to 0.1.1
