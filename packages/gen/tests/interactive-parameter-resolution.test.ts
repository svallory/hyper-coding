...
describe("Interactive Parameter Resolution", () => {
	...
	describe("Parameter Resolution Priority", () => {
		...
		it("should use defaults only when --defaults flag is used", async () => {
			...
			const resultWithDefaults = await resolver.resolveParametersInteractively(
				metadata,
				providedValues,
				{
					useDefaults: true,
		...
		it("should validate provided parameters before prompting", async () => {
			...
			await expect(
				resolver.resolveParametersInteractively(metadata, providedValues, {
					useDefaults: false,
				}),
	...
	describe("Option Handling", () => {
		it("should handle skipOptional option", async () => {
			...
			const resultSkipOptional = await resolver.resolveParametersInteractively(
				metadata,
				providedValues,
				{
					skipOptional: true,
