...
icon: "asterisk"
og:title: "Claude Code setup"
og:description: "Configure Claude Code for your documentation workflow"
---

Claude Code is Anthropic's official CLI tool. This guide walks you through setting up Claude Code to help you write and maintain your documentation.
