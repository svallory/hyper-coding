...
<CardGroup cols={2}>
  <Card title="hyper gen" href="/cli/commands/workflow/generate">
    Generate code from epic specifications
  </Card>
  <Card title="hyper watch" href="/cli/commands/workflow/develop">
    Monitor epic implementation progress
  </Card>
  <Card title="hyper dash" href="/cli/commands/dash">
    Monitor plan progress in real time
  </Card>
  <Card title="hyper plan" href="/cli/commands/tools/epics">
