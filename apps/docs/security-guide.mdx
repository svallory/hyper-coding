...
```javascript
// hypergen.config.js - Security configuration
export default {
  security: {
...
import { TemplateSecurityManager } from '@hyperdev/hypergen';
