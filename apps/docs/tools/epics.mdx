...
# Initialize with specific epic template
hyperdev epics init --template=saas-product

# Initialize with AI-assisted planning
hyperdev epics init --ai-planning

# Initialize with existing PRD
hyperdev epics init --prd=path/to/prd.md
```
...
hyperdev epics arch create

# Generate architecture diagrams
hyperdev epics arch diagram --type=system

# Validate architecture compliance
hyperdev epics arch validate

# Export architecture documentation
hyperdev epics arch export --format=pdf
```

### `hyperdev epics tasks`
...
# Create new epic
hyperdev epics tasks create-epic

# Break down epic into tasks
hyperdev epics tasks decompose <epic-id>

# Manage dependencies
hyperdev epics tasks dependencies
```
...
hyperdev epics dash --epic=user-auth

# Generate progress reports
hyperdev epics dash report --format=weekly

# View team allocation
hyperdev epics dash team-view
```
