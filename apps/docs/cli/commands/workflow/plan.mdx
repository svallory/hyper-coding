...
icon: "map"
og:title: "hyper plan"
og:description: "Strategic planning and architecture design with AI-powered plans and technical specifications"
---

# hyper plan

Strategic planning and architecture design tool that helps you break down complex features into implementable plans with AI-powered technical specifications and architecture guidance.
...
- **Plan management**: Create and manage feature plans with clear scope
...
<Info>
  `hyper plan` provides streamlined access to the planning tools, focusing on common planning workflows
