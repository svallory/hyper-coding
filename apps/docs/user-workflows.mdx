...
→ Ready to generate! Try: hypergen component MyButton
```
...
✨ Setup complete! Generated hypergen.config.js
```

### Team Configuration Sync
```bash
# Share configuration across team
hypergen config export team-config.json
hypergen config import team-config.json
```
...
hypergen preview react-component UserProfile
```
...
hypergen component UserCard --interactive=false

# Interactive mode for customization
hypergen component UserCard --interactive
```
...
💡 Tip: Try 'hypergen page UserProfile' to create a page using this component
```
...
hypergen create-template my-component
```
...
hypergen test-template my-component TestComponent
```
...
hypergen registry add @company/templates

# Publish team template
hypergen publish component-library
```
...
hypergen workflow create-feature
```
...
hypergen compose api-endpoint + react-page + tests
```
...
hypergen infra staging --environment=aws
```
...
💡 Suggestion: Component names should be PascalCase
   Try: hypergen component UserCard
...
```bash
# Context-aware help
hypergen help             # General help
hypergen help component   # Component-specific help
hypergen help --errors    # Common error solutions
```
