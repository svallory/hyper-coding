---
title: "hyper plan"
description: "Create and manage project plans with templates, documentation, and AI-powered architecture design"
---

import { Aside, CardGrid, Card } from '@astrojs/starlight/components';

<Aside type="caution" title="Spec Document — Coming Soon">
This page describes both **currently available** functionality and **planned features** that haven't been implemented yet. The spec sections serve as a living specification under [Docs-Driven Development](https://github.com/svallory/hyper-coding/discussions). Feedback welcome!
</Aside>
...
`hyper plan` covers basic plan management:
...
## Planned: AI-Powered Strategic Planning

The following sections describe the full vision for `hyper plan` — an interactive, AI-driven planning experience with architecture design, task breakdown, and project management integration.

### Interactive Planning Sessions

When the full experience ships, running `hyper plan` will give you an interactive session that walks you through scoping a feature or epic. It asks about your goals, stack, constraints, and timeline, then generates a structured set of artifacts: a PRD, a technical spec, a database/API design, and a task breakdown ready to hand off to `hyper gen`. You can stop at any layer — just need the task list? Exit after the breakdown. Want the full architecture? Keep going.
