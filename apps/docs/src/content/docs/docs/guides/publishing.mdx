...
This guide covers how to publish new versions of the HyperDev packages to npm. Most of the time the CI handles it---but it's useful to understand the full picture.
...
If the automated path is broken and you need to publish manually---don't make a habit of it:
