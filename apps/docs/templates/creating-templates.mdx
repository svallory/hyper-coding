...
icon: "document-text"
og:title: "Template Creation & Customization Guide"
og:description: "The definitive guide to building high-quality, reusable templates in HyperDev - from basic file generation to advanced TypeScript actions"
---
...
<Tabs>
  <Tab title="NPM Package">
    ...
    bunx hyper gen component MyComponent
    ```
  </Tab>
  ...
  <Tab title="Private Registry">
    ...
    bunx hyper config set registry https://templates.company.com
